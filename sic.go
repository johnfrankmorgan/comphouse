...
// SIC is a standard industrial classification of economic activities
type SIC string

// Description returns the description of a SIC code
func (m SIC) Description() string {
	if desc, ok := _sics[string(m)]; ok {
		return desc
	}
...
// https://github.com/companieshouse/api-enumerations/blob/c85c6639b8e99506571a31e601e29220dcfc4d83/constants.yml
var _sics = map[string]string{
